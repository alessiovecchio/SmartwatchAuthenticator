...
public class Constants {
    ...
    public static final float SAMPLING_FREQUENCY = 12.5f; //Sampling frequency (Hz)
    public static final int SAMPLING_PERIOD = 80; //(ms)
    ...
    public static final int SIMULATION_TIME = 3600000;
